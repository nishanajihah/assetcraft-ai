...
@riverpod
Stream<int> gemstoneStreamNotifier(GemstoneStreamNotifierRef ref) async* {
...
void checkAndShowDailyGemstoneNotification(
  ...
  try {
      ...
      next.whenData((notification) {
        if (notification != null && context.mounted) {
          try {
            ...
            AppLogger.error('Error showing daily gemstone notification: $e');
          }
        }
      });
    });
    ...
    AppLogger.error(
      'Error setting up daily gemstone notification listener: $e',
    );
  }
}
